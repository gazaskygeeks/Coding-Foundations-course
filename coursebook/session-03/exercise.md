...
12- The selected section from the paragraph should be 'white' with 'goldenrod' color for the background.
13- Add `Read More >>` with blue color after the paragraph using `after`.
